...
export const G = {
  ...
  uAmbSkyAbove: { value: new THREE.Vector3(0.62, 0.66, 0.9) },
  uAmbGroundAbove: { value: new THREE.Vector3(0.62, 0.52, 0.52) },
  uAmbSkyBelow: { value: new THREE.Vector3(0.5, 0.54, 0.72) },
  uAmbGroundBelow: { value: new THREE.Vector3(0.3, 0.3, 0.3) },
  // shadows
